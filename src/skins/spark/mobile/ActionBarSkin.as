...
public class ActionBarSkin extends MobileSkin
{
    ...
    public function ActionBarSkin()
    {
        ...
        borderClass = Skin_ActionBarBackground;
    ...
    override protected function createChildren():void
    {
        if (borderClass)
        {
            borderC = new borderClass();
            border = new SpriteVisualElement();
            border.addChild(borderC);
    ...
    override protected function layoutContents(unscaledWidth:Number, unscaledHeight:Number):void
    {
        ...
        if (border)
        {
            ...
            borderC.width = border.width;
            borderC.height = border.height;
        }
